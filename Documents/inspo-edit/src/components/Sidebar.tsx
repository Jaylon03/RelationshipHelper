...
export default function Sidebar() {
  ...
  function isActive(item: NavItem): boolean {
    if (item.highlight) return pathname === item.href;
  ...
  return (
    <aside className="w-60 min-h-screen bg-white border-r border-gray-200 flex flex-col flex-shrink-0">
      ...
      <div className="px-6 py-5 border-b border-gray-100">
        <Link href="/dashboard" className="font-bold text-xl tracking-tight text-gray-900">
      ...
      {/* User */}
      <div className="px-3 py-4 border-t border-gray-100 relative" ref={dropdownRef}>
        {dropdownOpen && (
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm hover:bg-gray-50 transition-colors"
        >
          ...
          <span className="text-gray-700 truncate flex-1 text-left text-xs">
            {email ?? "Loading..."}
          </span>
          <svg
